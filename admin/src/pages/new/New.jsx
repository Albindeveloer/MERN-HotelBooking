...
const New = ({ inputs, title }) => {
  ...
  const handleClick = async(e)=>{
    ...
    try{
      ...
      console.log(uploadRes.data)   //data.url vchum edukm, here object destructure aki ennolu
      const {url}=uploadRes.data

      const newUser = {
        ...info,          //...info kk pkram info nn just usecheythal, img vere object yi nikkum,here actully img ppend to info
        img: url,
      };
